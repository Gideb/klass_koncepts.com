  ...
  return (
    <div>
      <section className="max-w-7xl mx-auto min-h-screen px-6 sm:px-12 py-24 text-center">
        ...
        <h2 className="text-4xl sm:text-5xl font-bold mt-4 text-purple-700">
          Our{" "}
        ...
        <div className="mt-16">
          <div className="flex items-center justify-start gap-2 text-purple-600 text-xl font-bold mb-6">
            ...
            Digital & Web Solutions
            <span className="h-px w-170 bg-gray-200 ml-4"></span>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            <div className="bg-white p-6 rounded-xl shadow hover:shadow-lg transition cursor-pointer text-left border-2 border-gray-200">
        ...
        <div className="mt-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-1 gap-6">
            <div className="bg-white p-6 rounded-xl shadow hover:shadow-lg transition cursor-pointer max-w-md text-left border-2 border-gray-200">
              <div className="bg-purple-100 text-purple-600 w-12 h-12 flex items-center justify-center rounded-lg mb-4 ">
      ...
      <section
        id="why-us"
        className="px-6 sm:px-12 py-24 text-center bg-gray-100"
      >
        <div className="max-w-7xl mx-auto min-h-70">
          <div className="inline-flex items-center gap-2 bg-purple-100 text-purple-600 px-4 py-6 rounded-full text-sm font-medium w-fit mx-auto">
            <span className="w-2 h-2 bg-purple-600 rounded-full animate-pulse"></span>
            Why Us
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-4 gap-6 mt-20">
            <div className="bg-white px-8 py-10 rounded-xl shadow hover:shadow-lg transition cursor-pointer border-2 border-gray-200">
