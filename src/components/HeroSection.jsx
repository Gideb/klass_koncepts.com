...
const HeroSection = () => {
  return (
    ...
    >
      <video autoPlay loop playsInline muted poster={poster} className="w-full h-full object-cover absolute top-0 left-0 -z-2">
        <source src={bgVideo} type="video/mp4" />
      </video>
      <div className="px-8 max-w-7xl mx-auto flex items-center justify-between mt-30 gap-10 z-1">
